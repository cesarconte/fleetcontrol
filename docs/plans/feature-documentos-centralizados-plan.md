...
**Estado actual:** `DocumentsListPage.vue` es un stub de 12 líneas ("Página en construcción"). La infraestructura subyacente (tablas BD, servicios, composables, generadores PDF, constantes) existe pero está fragmentada por entidad.
...
| `src/components/documents/DocumentActionsDialog.vue`     | Componente | ~120        |
| `src/components/documents/DocumentActionsDialog.spec.js` | Test       | ~50         |
| `src/components/documents/VehicleDocumentsTable.vue`     | Componente | ~120        |
| `src/components/documents/DriverDocumentsTable.vue`      | Componente | ~120        |
| `src/components/documents/GeneratedDocumentsTable.vue`   | Componente | ~100        |
| `src/utils/export-documents.js`                          | Utilidad   | ~50         |
| `src/utils/export-documents.spec.js`                     | Test       | ~30         |

### A modificar (3)

| Archivo                              | Cambio                                     | Líneas est.  |
| ------------------------------------ | ------------------------------------------ | ------------ |
| `src/pages/DocumentsListPage.vue`    | Rewrite completo (stub → página funcional) | ~180 (de 12) |
| `src/constants/legal-limits.js`      | +sección DOCUMENT_MANAGEMENT               | +15          |
| `src/constants/legal-limits.spec.js` | +tests nuevas constantes                   | +8           |
...
| Líneas totales nuevas             | ~1,600              |
| Tests nuevos                      | ~850                |
| Tests totales proyecto (estimado) | 1202 + 850 = ~2,050 |
...
4. **Fase 3** — Componentes UI reutilizables
   - RED: Tests de renderizado que fallan
   - GREEN: Implementar chips, badges, filter bar, actions dialog
   - REFACTOR: Extraer helpers de formato

5. **Fase 4** — Página completa + tablas
   - RED: Tests de página que fallan
   - GREEN: Implementar DocumentsListPage + 3 tablas
   - REFACTOR: Extraer columnas a constantes
